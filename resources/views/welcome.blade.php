    		...
    		<div class="row">
              ...
              @foreach ($datas as $key )
                    ...
                    <div class="d-flex mb-3">
		    						...
		    						<p class="d-flex mb-0 d-block"><a href="/maintenance" class="btn btn-primary py-2 mr-1">Book now</a> <a href="/maintenance" class="btn btn-secondary py-2 ml-1">Details</a></p>
		    					</div>
		    				</div>
    					</div>
              @endforeach
